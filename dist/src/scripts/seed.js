...
async function seed() {
    ...
    await lesson_model_1.LearningLesson.insertMany([
        {
            id: "m1-u1-l1",
            unitId: "m1-u1",
    ...
    await lesson_content_model_1.LessonContent.insertMany([
        {
            id: "m1-u1-l1-c1",
            lessonId: "m1-u1-l1",
            type: "text",
    ...
    await quiz_model_1.Quiz.create({
        id: "quiz_m2_u1_l1",
        lessonId: "m2-u1-l1",
        title: "Travel Vocabulary Quiz",
        passingScore: 70,
    });
    await quiz_question_model_1.QuizQuestion.insertMany([
        {
            id: "quiz_m2_u1_l1_q1",
            quizId: "quiz_m2_u1_l1",
    ...
    await daily_review_model_1.DailyReview.create({
